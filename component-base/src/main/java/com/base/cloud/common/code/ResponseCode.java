package com.base.cloud.common.code;

import java.util.HashMap;
import java.util.Map;

import com.base.cloud.common.utils.result.Result;
...
public enum ResponseCode {
	...
	public static Result buildEnumResponseVO(ResponseCode vitalResponseCode, Object data) {
		return new Result(vitalResponseCode.getCode(),vitalResponseCode.getMessage(),data);
	}
	
	public static ResponseVO buildEnumResponseVO2(ResponseCode vitalResponseCode, Object data) {
